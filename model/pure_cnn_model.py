...
class PURECNNModel(BaseModel):
    def __init__(self, ch_in: int = 1, ch_out: int = 1, kernel_size: int = 5, stride: int = 1, padding: int = 0,
                 ...
                 init_method: str = "zeros", precision: torch.dtype = torch.float32, 
        ...
        if log:
            ...
            self._tb_path = f"runs/PURE_CNN_Model/{self.__tb_sub}"
    ...
    def forward(self, X: torch.tensor) -> torch.tensor:
        ...
        # forward pass into dense layers
